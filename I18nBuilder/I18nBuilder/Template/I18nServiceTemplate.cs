...
#line hidden
        ...
        public virtual string TransformText()
        {
            ...
            #line default
            #line hidden
            this.Write(".I18nBuilder.Service\r\n{\r\n    public sealed class I18nService:II18nDefaultService\r" +
                    "\n    {\r\n        string _deffaultLanguage =string.Empty;\r\n\r\n        string _curre" +
                    "ntLanguage=string.Empty;\r\n        \r\n        string[] _languages = [];\r\n\r\n       " +
                    " public string[] Langeuages => _languages;\r\n\r\n        public string CurrentLangu" +
                    "age => _currentLanguage;\r\n\r\n        public string DefaultLanguage => _deffaultLa" +
                    "nguage;\r\n\r\n        public IObservable<LanguageChangeEventArg> AfterLanguageChang" +
                    "eObservable { get; }=new I18nObservable<LanguageChangeEventArg>();\r\n\r\n        pu" +
                    "blic IObservable<string> LanguageChangeObservable { get; } = new I18nObservable<" +
                    ...
                    "e = _deffaultLanguage;\r\n        }\r\n\r\n        public bool ChangeCurrent(string la" +
                    "nguage)\r\n        {\r\n            if (!_languages.Any(t => t == language) || langu" +
                    "age == _currentLanguage)\r\n            {\r\n                return false;\r\n        " +
                    "    }\r\n            var beforeLanguage = _currentLanguage;\r\n            _currentL" +
                    "anguage = language;\r\n            return true;\r\n        }\r\n\r\n        public void " +
                    "ObserverExecute(string beforeLanguage)\r\n        {\r\n            (LanguageChangeOb" +
                    "servable as I18nObservable<string>)?.Execute(_currentLanguage);\r\n            (Af" +
                    "terLanguageChangeObservable as I18nObservable<LanguageChangeEventArg>)?.Execute(" +
                    "new LanguageChangeEventArg(beforeLanguage, _currentLanguage));\r\n        }\r\n    }" +
                    "\r\n}\r\n");
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "17.0.0.0")]
    public class I18nServiceTemplateBase
    {
        #region Fields
